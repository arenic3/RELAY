...
CREATE TABLE IF NOT EXISTS messages (id INT AUTO_INCREMENT, message VARCHAR(255), student_id INT, FOREIGN KEY (student_id) REFERENCES students(id), teacher_id INT, FOREIGN KEY (teacher_id) REFERENCES staff(id), primary key(id));
